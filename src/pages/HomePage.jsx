    ...
    <section className="cigr-hero">
      ...
      <div className="cigr-hero-inner">
        ...
        <div className="cigr-hero-actions">
          <a className="cigr-button yellow" href="#/nft">
            {t("home.cta.mint")}
          </a>
          ...
          <div className={`create-masonry-column offset-${column.offset}`} key={`create-column-${columnIndex}`}>
            {column.items.map((item, itemIndex) => {
              ...
              if (item.type === "action") {
                ...
                return (
                  <a className={cardClass} href={item.href} key={cardKey} target={isExternalLink ? "_blank" : undefined} rel={isExternalLink ? "noreferrer" : undefined}>
